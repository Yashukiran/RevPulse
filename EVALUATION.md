...
_Behind every number below is a reproducible script (`scripts/evaluate.py`, run 2026-08-28 13:34 UTC). Failures and false positives are reported, not hidden._
...
- **P5 repeat-rate association**: DETECTED — slow-service reviewers 8.0% (n=88) vs others 44.2% (n=208) — association, not causation

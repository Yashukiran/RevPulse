...
**Synthetic:** the dataset. 785 reviews, 300 customers and 2,231 orders generated by a committed, seeded script with planted patterns and an answer key — including decoys that must *not* be flagged, so false positives are measurable rather than merely absent. No real merchant has used this system.
